...
function EmailSender() {
    ...
    return (
        <div className="w-full min-h-screen flex justify-center items-center">
            <div className="email_card md:w-1/2 w-full mx-4 md:mx-0 bg-white dark:bg-gray-700 dark:text-white dark:border-none -mt-10 p-4 rounded-lg border shadow">
                <h1 className="text-gray-900 text-3xl dark:text-gray-200 ">Email Sender</h1>
                <p className='text-gray-800 dark:text-gray-300'>Send Email to your favourite person with your own app</p>
                <form action="" onSubmit={handleSubmit}>
                    ...
                    <div className="form_field mt-4">
                        ...
                        <Editor
                            ...
                            apiKey='qwblf1n6xcm3dvsp4sx9twhk6x0wr87eva4k6z129x4bvivz'
                        ...
                        <div className="button_container flex justify-center gap-2 mt-4">
                            ...
                            <button className='bg-gray-500 text-white hover:bg-gray-900 px-3 py-2 rounded'>
                                Clear
                            </button>
                        </div>
